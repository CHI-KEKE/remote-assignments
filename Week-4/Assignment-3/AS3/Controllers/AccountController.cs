...
namespace AS3.Controllers
{
    public class AccountController : Controller
    {
        public Assignment3DbContext Context { get; }
        private readonly IHttpContextAccessor _httpContextAccessor;


        public AccountController(Assignment3DbContext context, IHttpContextAccessor httpContextAccessor)
        {
            Context = context;
